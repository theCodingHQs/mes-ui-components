      ...
      <div className="max-w-3xl w-full space-y-12">
        <div className="space-y-4 text-center">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            A collection of meticulously crafted components for your next React
            application. Built with simplicity and elegance in mind.
          </p>
        </div>
        ...
        <div className="space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">
              Interactive buttons with smooth ripple effects and multiple
              variants.
            </p>
          </div>
        ...
        <div className="bg-card rounded-lg border shadow-sm p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-muted p-4 rounded-md overflow-x-auto">
              <pre>
                <code>npm install essence-ui</code>
              </pre>
            </div>
            <p className="text-muted-foreground">
            ...
            <div className="bg-muted p-4 rounded-md overflow-x-auto">
              <pre>
                <code>{`import { Button } from 'essence-ui';
